...
public class HotelReservation {
    ...
    public void cheapest_bestRated_hotel_RewardCustomer(){
     ...
     // Calculating Costiest Best Rated Hotel for Reward Customers.
    public void costiest_bestRated_hotel_RewardCustomer(){
        int sum_LakeWood = 0,sum_BridgeWood = 0, sum_RidgeWood = 0;
        int LakeWood_Rate =3, BridgeWood_Rate=4, RidgeWood_Rate=5;
        if (hotel == "LakeWood") {
            int weekday_rate = 80;
        ...
        if ((sum_BridgeWood<=sum_LakeWood && sum_RidgeWood<sum_BridgeWood) && (LakeWood_Rate<BridgeWood_Rate && BridgeWood_Rate<RidgeWood_Rate)){
            System.out.println("BridgeWood");
            System.out.println("Rating:"+BridgeWood_Rate);
            System.out.println("Total Rates: $"+sum_BridgeWood);
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        hotel3_rewardCustomer.cheapest_bestRated_hotel_RewardCustomer();
         ...
         //Displaying Costiest Best Rated Hotel for Reward Customers.
        hotel1_rewardCustomer.costiest_bestRated_hotel_RewardCustomer();
        hotel2_rewardCustomer.costiest_bestRated_hotel_RewardCustomer();
        hotel3_rewardCustomer.costiest_bestRated_hotel_RewardCustomer();
    }
}
